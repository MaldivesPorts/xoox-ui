import {PaginationItemValue} from "../../hooks/use-pagination";
import {useCallback} from "react";
import {forwardRef} from "../../core/system";
import {PaginationItemType} from "../../hooks/use-pagination";
import {ChevronIcon, EllipsisIcon, ForwardIcon} from "../../utilities/shared-icons";
    ...
    (value: PaginationItemValue, index: number) => {
      ...
      if (renderItemProp && typeof renderItemProp === "function") {
        return renderItemProp({
          ...
          onPrevious,
          setPage,
          ref: typeof value === "number" ? (node: HTMLElement | null) => getItemRef(node, value) : undefined,
