import type {InputSlots, InputVariantProps, SlotsToClasses} from '../../core/theme';
import {input} from '../../core/theme';

import {HTMLXooxUIProps, mapPropsVariants, PropGetter} from '../../core/system';
import {AriaTextFieldProps} from '@react-types/textfield';
import {useFocusRing} from '@react-aria/focus';
import {filterDOMProps, useDOMRef} from '../../utilities/react-utils';
import {useFocusWithin, useHover, usePress} from '@react-aria/interactions';
import {clsx, dataAttr, safeAriaLabel} from '../../utilities/shared-utils';
