import type {BreadcrumbsVariantProps, SlotsToClasses, BreadcrumbsSlots} from "../../core/theme";
...
import {breadcrumbs} from "../../core/theme";
import {filterDOMProps, pickChildren, ReactRef, useDOMRef} from "../../utilities/react-utils";
...
interface Props extends HTMLXooxUIProps<"nav">, AriaBreadcrumbsProps {
  /**
   * Ref to the DOM node.
   */
