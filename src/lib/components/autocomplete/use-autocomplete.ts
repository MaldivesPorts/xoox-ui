import type {AutocompleteSlots, AutocompleteVariantProps, SlotsToClasses} from '../../core/theme';
...
import {useComboBoxState, FilterFn} from '@react-stately/combobox';
...
interface Props<T> extends Omit<HTMLXooxUIProps<"input">, keyof ComboBoxProps<T>> {
    /**
     * Ref to the DOM node.
     */
