...
// import {useImage as useImageBase} from "./use-image";
...
export function useImage(originalProps: UseImageProps) {
  ...
  // const imageStatus: any = useImageBase({
  //   src,
  //   loading,
  //   onError,
  //   onLoad,
  ...
  const imageStatus: 'loaded' | 'loading' = "loading";
  const isImgLoaded: boolean = !!!isLoadingProp;
  const isLoading: boolean = imageStatus === "loading" || !!isLoadingProp;
